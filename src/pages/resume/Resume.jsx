                ...
                <div className="resume__info_experience">
                    <div className="experience__block">
                        ...
                        <div className="experience__block_details">
                            <p>
                            Сейчас работаю фронтенд разработчиком на React и параллельно продолжаю обучение. 
                            На текущий мемент прошел 5 онлайн курсов, разработал социальную сеть, интернет магазин, 
                            ToDo лист, чат и проект по сокращению ссылок на стеке MERN. Учебные проекты можно посмотреть 
                            в разделе Портфолио.
                            </p>
                        </div>
                    </div>
